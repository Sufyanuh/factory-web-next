...
(function (ue, de) {
        ...
        handler() {
          ...
          const t = () => this.$emit(),
            e = [
              ...
              ...(this.autoUpdate
                ? [
                    k([document, tt(this.$el)], "scroll", t, {
                      passive: !0,
                    }),
                  ]
                : []),
  ...
  function tl(t, e, i) {
    return [...t].sort(
      (s, n) =>
        ot(s, e).localeCompare(ot(n, e), void 0, {
          numeric: !0,
        }) * (i === "asc" || -1)
    );
  }
    ...
    scale: {
      ...
      translate(t) {
        return [
          {
            opacity: 1 - t,
            transform: he(1 - 0.2 * t),
          },
          {
            opacity: t,
            transform: he(1 - 0.2 + 0.2 * t),
          },
        ];
      },
    },
